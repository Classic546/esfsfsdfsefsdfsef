  ...
  Doors = {
    {
      ...
      break_items = {
        --lockpick        = {minigame = "Lockpick",   take_item = false, take_on_fail = false},
        --hacking_laptop  = {minigame = "Hacking",    take_item = false, take_on_fail = false},
        --lockpickv2      = {minigame = "LockpickV2", take_item = false, take_on_fail = false},
        thermite        = {minigame = "Thermite",   take_item = true, take_on_fail = false},
      },
    ...
    {    
      ...
      break_items = {
        lockpick = false,
        thermite = {minigame = 'Thermite',take_on_fail = false,take_item = true},
